...
- HUD panel, scroll arrow, and visual assertion badge JavaScript still need extraction from inline Java strings.
- API is not final.
...
2. Extract HUD panel, scroll arrow, and visual assertion badge JavaScript.
