...
- **[INTEGRATION] Allure:** keep Allure reports and attach Test Lens diagnostic/clean screenshots, HTML, and failure evidence through the native Allure lifecycle. [Allure integration](docs/integrations/allure.md)
