...
public final class HudTheme {
    ...
    public static HudTheme dark() {
        return builder()
                ...
                .warning("#f59e0b")
                .danger("#f87171")
                .borderColor("rgba(63, 63, 70, 0.86)")
                .borderRadiusPx(10)
                .fontSizePx(12)
                .fontFamily("Inter, system-ui, sans-serif")
                .boxShadow("0 16px 42px rgba(9, 9, 11, 0.42)")
                .opacity(1.0)
                .paddingPx(10)
                .gapPx(6)
                .maxHeightPx(480)
    ...
    public static HudTheme glass() {
        return builder()
                .background("linear-gradient(135deg, rgba(248, 250, 252, 0.20) 0%, rgba(15, 23, 42, 0.62) 34%, rgba(30, 41, 59, 0.54) 100%)")
                .foreground("#f8fafc")
                .mutedForeground("rgba(226, 232, 240, 0.80)")
                .accent("#38bdf8")
                .success("#22c55e")
                .warning("#facc15")
                .danger("#fb7185")
                ...
                .fontSizePx(13)
                .fontFamily("Inter, system-ui, sans-serif")
                .boxShadow("0 24px 70px rgba(2, 6, 23, 0.34), 0 8px 24px rgba(14, 165, 233, 0.10), inset 0 1px 0 rgba(255, 255, 255, 0.18), inset 0 -1px 0 rgba(15, 23, 42, 0.20)")
                .opacity(1.0)
    ...
    public static HudTheme highContrast() {
        return builder()
                ...
                .fontSizePx(13)
                .fontFamily("Inter, system-ui, sans-serif")
                .boxShadow("0 0 0 2px #f8fafc, 0 12px 32px rgba(2, 6, 23, 0.45)")
                .opacity(1.0)
                .paddingPx(10)
                .gapPx(6)
                .maxHeightPx(480)
