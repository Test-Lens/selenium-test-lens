...
foreach ($forbidden in @("selenium-test-lens-junit5", "selenium-test-lens-testng", "RedactionPolicy", "UiPageExpect", "NetworkHudFilter")) {
...
Write-Host "Documentation boundary OK: $version development source, immutable $ReleaseTag snapshot inventory verified."
