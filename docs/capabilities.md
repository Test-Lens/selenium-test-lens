...
| Assertions | [`UiExpect`](elements/assertions.md) | Polling visibility, enabled, text/value, collection count, DOM attribute, class token, computed CSS, selected/checked, and attached/detached assertions with typed results. |
