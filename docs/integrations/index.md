...
The main Lens facade is runner-agnostic and attaches to an already-created driver. This section covers lifecycle adapters and coexistence with external runners and reporting tools. See [existing WebDriver integration](../framework-integration.md) for Page Objects, Allure coexistence, and manual lifecycle patterns.
