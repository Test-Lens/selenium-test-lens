...
- Passive network diagnostics: `selenium.network.NetworkDiagnostics`, request/response/failure event models, wait-for-response/no-failed-request assertions, JSON export, and trace `NETWORK_LOG` attachment.
